...
const Dashboard1FullscreenLayout: React.FC<Dashboard1FullscreenLayoutProps> = ({
  ...
  const blocks = [
    { component: defaultAlive, name: 'Default Alive', icon: '💰', duration: 180 }, // 3 minutes
    { component: publicEngagement, name: 'Public Engagement', icon: '👥', duration: 180 }, // 3 minutes
    { component: fundraisingPipeline, name: 'Fundraising Pipeline', icon: '📊', duration: 180 } // 3 minutes
  ];
